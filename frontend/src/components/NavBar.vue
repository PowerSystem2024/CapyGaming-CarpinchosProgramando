    ...
    <div class="navbar-content">
      ...
      <div class="search" ref="buscador">
        ...
        <ul v-if="mostrarSugerencias && sugerencias.length" class="sugerencias-list">
          <li v-for="(producto, index) in sugerencias" :key="index" @click="irADetalle(producto.id_producto)">
            {{ producto.nombre }}
          </li>
        </ul>
      </div>
    ...
    <transition name="slide-fade">
      <div v-if="menuAbierto" class="menu-responsive">
        ...
        <div class="menu-section">
          ...
          <button v-if="!isAuthenticated" @click="abrirAuthModal" class="menu-link">
...
.sugerencias-list li {
  ...
  overflow: hidden;
  /* Oculta el texto que se pasa del ancho */
  text-overflow: ellipsis;
  /* Agrega "..." al final si se corta */
...
.user-options {
  display: flex;
  /* pone los botones en fila */
  align-items: center;
  /* centra verticalmente */
  gap: 1rem;
  /* espacio entre “Ingresá” y carrito */
}
...
/* Estilos para menú móvil autenticado */
.user-menu-mobile {
  display: flex;
